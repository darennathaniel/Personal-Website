...
function Education() {
  ...
  //             src="https://www.ntu.edu.sg/images/default-source/from-figma/ntu-placeholder-d.jpg?sfvrsn=d4050a9e_2"
  //             alt="First slide"
  //           />
  //           <Carousel.Caption>
  //             <h3 className="educationText">First slide label</h3>
  ...
  //           />
  //           <Carousel.Caption>
  //             <h3 className="educationText">Second slide label</h3>
  //             <p className="educationText">
